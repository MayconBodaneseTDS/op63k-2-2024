...
public class AvaliableAccountValiadationTest {
    ...
    @Test
    void deveriaSerValidoComSaldoELimite() {
        // Arrange
    ...
    @Test
    void deveriaGerarExcecaoQuandoSaldoInsuficienteELimite() {
        // Arrange
    ...
    @Test
    void deveriaGerarExcecaoQuandoQuantiaFor1MaiorQueSaldoComLimite() {
        // Arrange
        var sourceAccount = new Account("Estudante Universitário", 12345, 1000, 500);
